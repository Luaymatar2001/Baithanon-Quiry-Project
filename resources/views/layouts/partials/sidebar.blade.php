...
<aside
    ...
    class="fixed right-0 h-screen w-64 bg-gray-800 text-blue-100
...
>
    ...
    <header class="h-16 flex items-center px-4 shadow-md bg-gray-800 sticky top-0 z-30">
        <a href="#" class="text-white flex items-center space-x-reverse space-x-2">
            ...
            <div>
                <span class="text-xl font-bold block">جمعية بيت حانون</span>
                <span class="text-xs text-gray-400">إدارة البيانات</span>
            </div>
        </a>
    </header>
        ...
        <ul class="space-y-2 text-sm">
            ...
            <li x-data="{ open:false }">
                ...
                <ul x-show="open" x-collapse
                    class="mt-2 mr-3 border-r border-gray-700 space-y-1 text-xs">
                    <li>
