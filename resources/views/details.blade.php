        ...
        document.addEventListener('DOMContentLoaded', function () {
          ...
          open_reg_married.addEventListener('click', () => {
               Swal.fire({
                ...
                text: 'يجب حذف بيانات الزوج والزوجة من ملففات أرباب الأسر , وكذالك إخراجهما من جدول الأبناء قبل تقديم طلب الإضافة , لن يتم قبول طلب الإضافة في حال عدم تنفيذ هذه الخطوة !',
                icon:'warning',
